...
public:
		...
		: m_capture(0), m_frame(0)
	{
		...
		cvSetCaptureProperty(m_capture, CV_CAP_PROP_FPS, 24);
		...
		cvSetCaptureProperty(m_capture, CV_CAP_PROP_FRAME_WIDTH, 80);
		cvSetCaptureProperty(m_capture, CV_CAP_PROP_FRAME_HEIGHT, 60);
